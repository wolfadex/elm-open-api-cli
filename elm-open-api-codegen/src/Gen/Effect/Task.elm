module Gen.Effect.Task exposing
    ( moduleName_, onError, sequence, mapError, map5, map4
    , map3, map2, map, fail, succeed, andThen, attempt
    , perform, annotation_, call_, values_
    )

{-|
# Generated bindings for Effect.Task

@docs moduleName_, onError, sequence, mapError, map5, map4
@docs map3, map2, map, fail, succeed, andThen
@docs attempt, perform, annotation_, call_, values_
-}
