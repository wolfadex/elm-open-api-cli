        ...
        \msgExpression msgTags ->
            Elm.Case.custom
                ...
                , Elm.Case.branch
                    (Elm.Arg.customType
                       "UrlChanged"
                       msgTags.urlChanged |> Elm.Arg.item (Elm.Arg.var "urlUrl")
                    )
                    Basics.identity
                , Elm.Case.branch
                    (Elm.Arg.customType
                       ...
                       msgTags.userMsg |> Elm.Arg.item
                                                (Elm.Arg.var "pagesMsgPagesMsg")
                    )
                    Basics.identity
                , Elm.Case.branch
                    (Elm.Arg.customType
                       "FormMsg"
                       msgTags.formMsg |> Elm.Arg.item (Elm.Arg.var "formMsg")
                    )
                    Basics.identity
                , Elm.Case.branch
                    (Elm.Arg.customType
