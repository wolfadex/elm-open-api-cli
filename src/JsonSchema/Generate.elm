...
schemaToDeclarations : Common.UnsafeName -> Json.Schema.Definitions.Schema -> CliMonad (List { module_ : Common.Module, declaration : Elm.Declaration, group : String })
                                            ...
                                            |> List.map
                                                (\variant ->
                                                    Elm.Case.branch
                                                        ...
                                                        (\_ -> Elm.string (Common.unwrapUnsafe variant))
                                                )
